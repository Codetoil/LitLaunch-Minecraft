...
import io.github.codetoil.litlaunch._native.mc1144.proxy.ClientProxy1144;
import io.github.codetoil.litlaunch._native.mc1144.proxy.ServerProxy1144;
...
public class Launch1144 implements INativeLaunch {
    ...
    public void setup(final FMLCommonSetupEvent event) {
        ...
        try {
            ...
            LaunchCommon.bootstrap(LogManager.getLogger(LaunchCommon.MODID), getClass().getClassLoader(), this, Logger1144.getInstance());
        } catch (Throwable t) {
