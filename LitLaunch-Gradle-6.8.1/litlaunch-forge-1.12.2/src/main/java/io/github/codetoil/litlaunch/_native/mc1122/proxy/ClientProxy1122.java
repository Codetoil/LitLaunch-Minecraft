...
package io.github.codetoil.litlaunch._native.mc1122.proxy;

import io.github.codetoil.litlaunch._native.mc1122.CommandNew;
...
public class ClientProxy1122 implements ICommonProxy {
    @Override
    public void setGamePath() {
        LitLaunch.getLogger().info("LitLaunch Client Proxy Setting Game Path On LitLaunch!");
        LaunchCommon.setGamePath(Minecraft.getMinecraft().gameDir.toPath());
    }
