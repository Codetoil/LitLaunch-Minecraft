package io.github.codetoil.litlaunch._native.mc1165.proxy;
...
public class ClientProxy1165 implements ICommonProxy {
        ...
        ModFinder.validMods.forEach((modClass) -> {
            try {
                ...
                if (oCommands instanceof List) {
                    ...
                    LitLaunch.getLogger().error("Mod " + modClass + " does not have a field named \"commandList\". This is neccesary for the command api to work though. Skipping!");
                }
                ...
                if (e.getMessage().contains("/" + command.name)) {
                    ...
                    try {
                        ...
                        if (help instanceof ITextComponent) {
                            ...
                            Minecraft.getInstance().player.sendStatusMessage(new StringTextComponent(helpSTR), false);
                        }
                        return;
                    }
                    try {
