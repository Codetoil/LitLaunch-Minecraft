...
public class EventThrowingClientPlayNetHandler extends NetHandlerPlayClient
{
	...
	{
		super(Minecraft.getMinecraft(), ObfuscationReflectionHelper.getPrivateValue(NetHandlerPlayClient.class, netHandlerOriginal, "field_147307_j", "guiScreenServer"), netHandlerOriginal.getNetworkManager());
	...
	public void handleTimeUpdate(S03PacketTimeUpdate packetIn)
	{
		...
		LitEventHandler.COMMON.post(
				new LitEvent(this, LitEvent.TYPE.ONPACKET,
						ChainableMap.<String, Object>newMap()
								.putChain("Type", "WorldTime")
								.putChain("totalWorldTime", packetIn.func_149366_c())
								.putChain("worldTime", packetIn.func_149365_d())
								.putChain("raw", packetIn))
				, true);
	}
	...
	{
		netHandlerOriginal.onConnectionStateTransition(p_147232_1_, p_147232_2_);
	}

	@Override
	public void onNetworkTick()
	{
		netHandlerOriginal.onNetworkTick();
	}
}
