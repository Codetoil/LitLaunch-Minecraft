...
import io.github.codetoil.litlaunch._native.mc1_7.proxy.ClientProxy1_7;
import io.github.codetoil.litlaunch._native.mc1_7.proxy.ServerProxy1_7;
...
public class Launch1_7 implements ILaunch
{
	...
	public static final io.github.codetoil.litlaunch._native.mc1_7.EventHandler handler = new io.github.codetoil.litlaunch._native.mc1_7.EventHandler();
	...
	public Launch1_7()
	{
		...
		try
		{
			LaunchCommon.bootstrap(LogManager.getLogger(LaunchCommon.MODID), this, Logger1_7.getInstance());
		}
		catch (Throwable t)
		{
