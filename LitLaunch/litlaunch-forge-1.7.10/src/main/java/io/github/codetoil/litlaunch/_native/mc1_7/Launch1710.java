...
import io.github.codetoil.litlaunch._native.mc1_7.proxy.ClientProxy1710;
import io.github.codetoil.litlaunch._native.mc1_7.proxy.ServerProxy1710;
...
public class Launch1710 implements ILaunch {
    ...
    public Launch1710() {
        ...
        try {
            LaunchCommon.bootstrap(LogManager.getLogger(LaunchCommon.MODID), this, Logger1710.getInstance());
        } catch (Throwable t) {
