...
public class ArgumentType<T> {
    ...
    public ArgumentType(String name, IArgumentParser<? extends IArgumentValue<T>> parser, String pDescription, boolean pIsRequired) {
        this.name = name;
        this.parser = parser;
    ...
    public ArgumentType(String name, IArgumentParser<? extends IArgumentValue<T>> parser, boolean pIsRequired) {
        this(name, parser, name, pIsRequired);
    }

    public ArgumentType(String name, IArgumentParser<? extends IArgumentValue<T>> parser, String pDescription) {
    ...
    public ArgumentType<T> setDescription(String pDescription) {
