...
public class Launch1_15 implements ILaunch {
    ...
    public Launch1_15() throws Throwable {
        ...
        try {
            LaunchCommon.bootstrap(LogManager.getLogger(LaunchCommon.MODID), this, Logger1_15.getInstance());
        } catch (Throwable t) {
    ...
    public boolean setProxy() {
        ...
        if (LaunchCommon.getCcproxy() != null) {
            ...
            switch (side) {
                case CLIENT:
                    LaunchCommon.setCcproxy(new io.github.codetoil.litlaunch._native.mc1_15.proxy.ClientProxy1_15());
                    result = true;
                    break;
                case DEDICATED_SERVER:
                    LaunchCommon.setCcproxy(new io.github.codetoil.litlaunch._native.mc1_15.proxy.ServerProxy1_15());
                    result = true;
                    break;
                default:
