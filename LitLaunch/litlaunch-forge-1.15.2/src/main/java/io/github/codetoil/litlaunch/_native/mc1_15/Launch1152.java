...
import io.github.codetoil.litlaunch._native.mc1_15.proxy.ClientProxy1152;
import io.github.codetoil.litlaunch._native.mc1_15.proxy.ServerProxy1152;
...
public class Launch1152 implements ILaunch {
    ...
    public Launch1152() throws Throwable {
        ...
        try {
            LaunchCommon.bootstrap(LogManager.getLogger(LaunchCommon.MODID), this, Logger1152.getInstance());
        } catch (Throwable t) {
