...
import io.github.codetoil.litlaunch._native.mc1_12.proxy.ClientProxy1122;
import io.github.codetoil.litlaunch._native.mc1_12.proxy.ServerProxy1122;
...
@Mod(modid = LaunchCommon.MODID, version = Launch1122.VERSION, name = LaunchCommon.NAME)
public class Launch1122 implements ILaunch {
    ...
    public Launch1122() {
        ...
        try {
            LaunchCommon.bootstrap(LogManager.getLogger(LaunchCommon.MODID), this, Logger1122.getInstance());
        } catch (Throwable t) {
