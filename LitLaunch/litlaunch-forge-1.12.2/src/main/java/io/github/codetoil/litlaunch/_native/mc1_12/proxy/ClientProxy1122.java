...
public class ClientProxy1122 implements CommonProxy {
    @Override
            ...
            try {
                ...
                if (oCommands instanceof List) {
                    ...
                    lCommands.forEach((command) -> {
                        if (command instanceof Command && (Command.Side.CLIENT.equals(((Command) command).side) || Command.Side.BOTH.equals(((Command) command).side))) {
