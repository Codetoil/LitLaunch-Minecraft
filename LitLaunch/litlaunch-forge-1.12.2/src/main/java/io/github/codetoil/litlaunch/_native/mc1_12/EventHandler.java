...
public class EventHandler {
    ...
    public void onServerTick(TickEvent.ServerTickEvent event) {
        if (event.phase.equals(TickEvent.Phase.END)) {
            LitEventHandler.SERVER.post(new LitEvent(this, LitEvent.TYPE.SERVERTICK, FrontEnd.EMPTY), true);
        }
    }
    ...
    public void ServerConnect(FMLNetworkEvent.ClientConnectedToServerEvent event) {
        LitEventHandler.CLIENT.post(new LitEvent(EventHandler.class, LitEvent.TYPE.SERVERCONNECT, FrontEnd.EMPTY));
