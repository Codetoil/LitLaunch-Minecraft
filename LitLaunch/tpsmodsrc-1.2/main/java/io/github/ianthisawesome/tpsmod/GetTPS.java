		...
		try
		{
			if (worldIn.getTotalWorldTime() == 0)
			{
				...
				if (worldIn.getTotalWorldTime() == 0)
				{
					...
					if (worldIn.getTotalWorldTime() == 0)
					{
						LOGGER.error("The TotalWorldTime is 0 after waiting for the TotalWorldTime");
						LOGGER.error("This should not happen!");
						LOGGER.error("Please send a bug report to to @codetoil on twitter or ianthisawesomee@gmail.com!");
					}
				}
			}
