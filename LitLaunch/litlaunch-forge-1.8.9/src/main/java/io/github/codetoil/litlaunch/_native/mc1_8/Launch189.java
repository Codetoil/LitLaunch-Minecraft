...
import io.github.codetoil.litlaunch._native.mc1_8.proxy.ClientProxy189;
import io.github.codetoil.litlaunch._native.mc1_8.proxy.ServerProxy189;
...
public class Launch189 implements ILaunch {
    ...
    public Launch189() {
        ...
        try {
            LaunchCommon.bootstrap(LogManager.getLogger(LaunchCommon.MODID), this, Logger189.getInstance());
        } catch (Throwable t) {
