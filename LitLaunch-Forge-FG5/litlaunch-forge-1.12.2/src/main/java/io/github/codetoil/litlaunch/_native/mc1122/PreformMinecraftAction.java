...
public class PreformMinecraftAction implements IPreformMinecraftAction {
    ...
    private PreformMinecraftAction() {
    }
    ...
    public void notifyPlayer(String message, Color pColor, boolean isBold, boolean isItalic, boolean isUnderlined, boolean isObfuscated, boolean hasStrikethrough) {
        Minecraft.getMinecraft().player.sendMessage(new TextComponentString(message).setStyle(getStyle(pColor, isBold, isItalic, isUnderlined, isObfuscated, hasStrikethrough)));
    }
