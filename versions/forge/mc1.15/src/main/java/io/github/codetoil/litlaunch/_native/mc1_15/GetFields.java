...
{
	public static final IGetFields INSTANCE = new io.github.codetoil.litlaunch._native.mc1_15.GetFields();
	...
	{
		Iterator<DimensionType> dims = DimensionType.getAll().iterator();
